...
public class ShellSorter {
	...
	public void sort(final Integer[] data) {
	...
	private void insertionSortWithGap(final Integer[] data, final int startIndex, final int gap) {
		int i = startIndex;
		while (i < data.length) {
	...
	private int maxKnuthSeqNumber(final int size) {
		int h = 1;
		while (h < size/3) {
			h = 3 * h + 1;
		}
	...
	public static void main(final String[] args) {
		...
		final Integer[] data1 = new Integer[lengthOfArray];
		...
		final Integer[] data2 = new Integer[lengthOfArray];
